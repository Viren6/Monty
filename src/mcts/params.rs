...
make_mcts_params! {
    ...
    tm_best_var_kt: f32 = 0.25, 0.0, 1.0, 0.025, 0.002;
    tm_best_var_slope: f32 = 1.0, 0.0, 5.0, 0.1, 0.002;
    tm_best_var_min: f32 = 0.5, 0.1, 1.0, 0.05, 0.002;
    tm_best_var_max: f32 = 1.5, 1.0, 5.0, 0.15, 0.002;
}
