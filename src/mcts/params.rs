...
make_mcts_params! {
    ...
    tm_c_base: f64 = 0.022, 0.001, 0.1, 0.005, 0.002;
    tm_c_ply_mult: f64 = 0.0065, 0.0, 0.05, 0.001, 0.002;
    tm_c_ply_pow: f64 = 0.5, 0.1, 2.0, 0.1, 0.002;
    tm_bonus_val: f64 = 0.06, 0.0, 1.0, 0.01, 0.002;
    tm_bonus_ply: f64 = 12.0, 1.0, 50.0, 1.0, 0.002;
    tm_max_base: f64 = 5.2, 1.0, 20.0, 0.5, 0.002;
    tm_max_ply_mult: f64 = 0.01, 0.0, 1.0, 0.01, 0.002;
